...
I am a **PhD Candidate in Mechanical Engineering at Memorial University of Newfoundland**, where I am a member of the [**At. Astra Research Group**](https://sites.google.com/mun.ca/atastragroup). My work combines **molecular dynamics simulations** with planetary and materials science to uncover how **space weathering** transforms the surfaces of airless bodies (like the Moon and Mercury) and materials (like nanocomposites).
...
- **Habitability and survivability on other planets** - Using atomic-scale simulations to study possible survivability of biomolecular structures such as amino acids on other planets.
- **Molecules sputter too** – Using molecular dynamics to reveal that not only atoms, but also complex molecules, can be ejected under solar wind bombardment.
- **Sodium release from silicates** – Atomistic models of adsorption, diffusion, and desorption processes of sodium from silicates.  

### 🚀 Vision
By bridging **planetary/materials science, and computational modelling**, my goal is to answer fundamental questions about the evolution and  surface modifications of planets and how life's building blocks may survive in the harsh conditions of space.
